...
**License warning:** OBLITERATUS is AGPL-3.0. NEVER import it as a Python library inside an MIT/Apache-licensed project. Always invoke via CLI (`obliteratus` command) or subprocess to keep your project's license clean.

## Video Guide

Walkthrough of OBLITERATUS used by an agent to abliterate Gemma:
...
Read `references/analysis-modules.md` (relative to this skill dir) for the full reference.
...
Read these template files (relative to this skill dir) for reproducible runs:
