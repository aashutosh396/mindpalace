---
name: openhue
description: "Control Philips Hue lights, scenes, and rooms from the terminal via the OpenHue CLI when the user wants to turn on/off, dim, recolor, or set scenes."
version: 1.0.0
author: community
license: MIT
...
- Works great with scheduled lighting via mindpalace-cron (`orchestrator/mpcron.py`) — e.g. dim at bedtime, bright at wake
