---
name: jules
description: Delegate coding tasks to the Google Jules AI agent for asynchronous execution. Use when the user says "have Jules fix", "delegate to Jules", "send to Jules", "ask Jules to", "check Jules sessions", "pull Jules results", "jules add tests", "jules add docs", or "jules review pr". Handles bug fixes, documentation, features, tests, refactoring, and code reviews. Works with GitHub repos and creates PRs.
version: 1.0.0
license: Apache-2.0
tags: [autonomous-ai-agents, delegation, coding, github, async, automation, code-review]
