---
name: manus
description: Delegate complex, long-running tasks to the Manus AI agent for autonomous execution. Use when the user says "use manus", "delegate to manus", "send to manus", "have manus do", "ask manus", "check manus sessions", or when tasks require deep web research, market analysis, product comparisons, stock analysis, competitive research, document generation, data analysis, or multi-step workflows that benefit from autonomous agent execution with parallel processing.
version: 1.0.0
license: Apache-2.0
tags: [autonomous-ai-agents, delegation, research, agent, async, automation]
source: https://github.com/sanjay3290/ai-skills/tree/main/skills/manus
