---
name: google-tts
description: Convert documents and text to audio using Google Cloud Text-to-Speech. Use when the user wants to narrate a document, read aloud text, generate audio from a file, convert text to speech, or create a podcast from a document. Trigger phrases - "read this aloud", "narrate this", "create a recording", "text to speech", "TTS", "convert to audio", "audio from document", "google tts", "create a podcast".
version: 1.0.0
license: Apache-2.0
tags: [media, tts, audio, text-to-speech, podcast, google-cloud, narration]
