---
name: atlassian
description: Manage Jira issues and Confluence wiki pages in Atlassian Cloud. Use when searching/creating/updating Jira issues with JQL, searching/reading/creating Confluence pages with CQL, managing Jira workflows, transitions, and comments, or browsing Confluence spaces and page hierarchies. Supports OAuth 2.1 via MCP server (recommended) or API token authentication (fallback).
version: 1.0.0
license: Apache-2.0
tags: [project-management, jira, confluence, atlassian, issue-tracking, wiki, docs]
source: https://github.com/sanjay3290/ai-skills/tree/main/skills/atlassian
