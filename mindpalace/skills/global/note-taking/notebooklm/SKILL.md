---
name: notebooklm
description: Query and manage Google NotebookLM notebooks with persistent profile auth, source sync, batch/multi queries, and structured exports. Use when the user asks to query NotebookLM, "ask my notebook", shares NotebookLM notebook URLs, wants to list/create notebooks, manage sources, do bulk folder sync, dedupe, or audit exports.
version: 1.0.0
license: Apache-2.0
tags: [note-taking, notebooklm, research, knowledge-base, google, browser-automation]
