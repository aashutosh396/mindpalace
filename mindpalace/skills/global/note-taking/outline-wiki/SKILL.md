---
name: outline-wiki
description: Search, read, and manage Outline wiki documents. Use when searching a wiki for documentation, reading wiki pages or articles, listing wiki collections or documents, creating or updating wiki content, or exporting documents as markdown. Works with any Outline wiki instance (self-hosted or cloud).
version: 1.0.0
license: Apache-2.0
tags: [note-taking, wiki, outline, documentation, knowledge-base, docs]
