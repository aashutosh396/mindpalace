...
2. **File** — user points at a file. Read it, then apply edits with your file-editing tools. For markdown docs in a repo, a targeted per-section edit is cleaner than rewriting the whole file.
