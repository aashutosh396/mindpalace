...
| **TTS narration** | Text quotes + any TTS CLI/API | Narrated testimonial/quote video with typed text | `references/inputs.md` § TTS Integration |
...
| TTS | any TTS CLI/API (optional, e.g. `say`, espeak, or a cloud TTS) | Generate narration clips |
...
| `references/inputs.md` | Audio analysis (FFT, bands, beats), video sampling, image conversion, text/lyrics, TTS integration (any TTS provider, voice assignment, audio mixing) |
