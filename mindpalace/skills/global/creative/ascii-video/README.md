...
Built for [mindpalace](https://github.com/NousResearch/mindpalace-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/mindpalace-agent/skills/creative/ascii-video`](https://github.com/NousResearch/mindpalace-agent/tree/main/skills/creative/ascii-video) via PR.
